...
export class FoodSearchContainerComponent implements OnInit {
  ...
  get placeholder(): string { return this.config.placeholder || 'Search for food or scan barcode...'; }
  get showBarcodeScanner(): boolean { return this.config.showBarcodeScanner ?? true; }
  get layout(): FoodResultsLayout { return this.config.layout || 'list'; }  get pageSize(): number { return this.config.pageSize || 6; }
  get possiblePageSizes(): number[] { return this.config.possiblePageSizes || [6, 12, 18, 24, 30]; }
  get showSearchOptions(): boolean { return this.config.showSearchOptions ?? true; }
  get showLayoutOptions(): boolean { return this.config.showLayoutOptions ?? true; }
  get showRecentFoods(): boolean { return this.config.showRecentFoods ?? true; }
  get showResultsHeader(): boolean { return this.config.showResultsHeader ?? true; }
  get showPagination(): boolean { return this.config.showPagination ?? true; }
  get showImages(): boolean { return this.config.showImages ?? true; }
  get showNutrition(): boolean { return this.config.showNutrition ?? true; }
  get showBrand(): boolean { return this.config.showBrand ?? true; }
  get showTags(): boolean { return this.config.showTags ?? true; }
  get actionButtonText(): string { return this.config.actionButtonText || 'Add'; }
  get actionButtonIcon(): string { return this.config.actionButtonIcon || 'fas fa-plus'; }
  get emptySearchMessage(): string { return this.config.emptySearchMessage || 'No foods found for your search'; }
  get emptyRecentMessage(): string { return this.config.emptyRecentMessage || 'No recently added foods'; }
  get emptySearchIcon(): string { return this.config.emptySearchIcon || 'fas fa-search'; }
  get emptyRecentIcon(): string { return this.config.emptyRecentIcon || 'fas fa-history'; }
  get initialStateMessage(): string { return this.config.initialStateMessage || 'Enter a food name above or scan a barcode to find foods.'; }
  get initialStateIcon(): string { return this.config.initialStateIcon || 'fas fa-search'; }
  ...
  onPageSizeChange(pageSize: number) {
    // Update the config to maintain consistency
  ...
  get showResults(): boolean {
    return (this.isSearchMode && !!this.searchResponse) || 
  ...
  get showRecentSection(): boolean {
    return this.showRecentFoods && !this.hasQuery && !!this.recentFoodsResponse?.foods?.length;
  }
  ...
  get currentEmptyMessage(): string {
    return this.isSearchMode ? this.emptySearchMessage : this.emptyRecentMessage;
  }
