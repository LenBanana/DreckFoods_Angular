    ...
    >
      <div class="alert-icon">
        <ng-container [ngSwitch]="alert.type">
          ...
          </svg>          <svg *ngSwitchCase="'confirm'" class="icon" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
          </svg>
          <svg *ngSwitchCase="'input'" class="icon" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="alert-input-container" *ngIf="alert.type === 'input' && alert.inputConfig">          <input
            #inputElement
            class="alert-input"
          ...
          />
          <div class="alert-input-error" *ngIf="inputError">{{ inputError }}</div>
        </div>
